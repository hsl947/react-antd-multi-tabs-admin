...
class Editor extends React.Component {
  uploadFn = (param) => {
    const serverURL = `${process.env.REACT_APP_BASE_URL}/api/common/upload`
  ...
  render() {
    ...
    const { mediaType, value, onChange } = this.props
    ...
    const accepts = {
      image: mediaType === 'video' ? false : 'image/png, image/jpeg, image/gif',
      video: mediaType === 'picture' ? false : 'video/mp4'
    }
